...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: route('user.admin.user-groups.create') },
];

const submit = () => {
    form.post(route('user.admin.user-groups.store'));
};
...
<template>
    <Head title="Create User Group - Admin" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <h1 class="text-2xl font-bold">Create User Group</h1>
